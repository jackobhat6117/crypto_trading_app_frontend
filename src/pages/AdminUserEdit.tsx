...
export default function AdminUserEdit() {
  ...
  const fieldClass =
    'mt-1 w-full rounded-lg border border-white/10 bg-[#0d1117] px-3 py-2.5 text-sm text-white outline-none focus:border-indigo-500/60'
        ...
        <Card title="User Information" icon={UserRound} tone="bg-indigo-500/20 text-indigo-300">
          <div className="space-y-3">
            <div>
              ...
              <input className={fieldClass} value={info.email} onChange={(e) => setInfo({ ...info, email: e.target.value })} />
            </div>
            <div>
              <label className={labelClass}>Full Name</label>
              <input className={fieldClass} value={info.name} onChange={(e) => setInfo({ ...info, name: e.target.value })} />
            </div>
            <div>
              <label className={labelClass}>Unique ID</label>
              <input className={fieldClass} value={info.uniqueId} onChange={(e) => setInfo({ ...info, uniqueId: e.target.value })} />
              <p className="mt-1 text-xs text-slate-500">Unique identifier for this user.</p>
            </div>
            <div>
              <label className={labelClass}>Phone</label>
              <input className={fieldClass} value={info.phone} onChange={(e) => setInfo({ ...info, phone: e.target.value })} />
            </div>
            <div>
